defmodule BarbertimeWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use BarbertimeWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Barbertime.ProfileFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Barbertime.Profile.generate_user_session_token(user)
